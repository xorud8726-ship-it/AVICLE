...
ITEMS: List[Dict[str, str]] = [
    ...
    {"id":"rgb_led_90","name":"RGB 90cm","category":"LED (RGB/무빙)","image":"led", "price": "26250"},
    {"id":"moving_led_110","name":"무빙 110cm","category":"LED (RGB/무빙)","image":"led", "price": "39900"},
    {"id":"moving_led_90","name":"무빙 90cm","category":"LED (RGB/무빙)","image":"led", "price": "30450"},
    {"id":"moving_led_50","name":"무빙 50cm","category":"LED (RGB/무빙)","image":"led", "price": "18900"},
    {"id":"moving_led_30","name":"무빙 30cm","category":"LED (RGB/무빙)","image":"led", "price": "15750"},
    {"id":"moving_led_15_soldout","name":"무빙 15cm(품절)","category":"LED (RGB/무빙)","image":"led", "price": "11550"},
    {"id":"haodeng_bt","name":"RGB 블루투스 모듈(하우동)","category":"모듈 (세트,단품)","image":"haodeng", "price": "22000"},
    {"id":"oem_rgb_set","name":"순정연동 RGB 모듈 1개 세트(RGB 모듈,110 1개 ,90 4개)","category":"모듈 (세트,단품)","image":"rgb110", "price": "183750"},
    ...
    {"id":"oem_v4_pro_set","name":"순정연동 V4 PRO 모듈 1개 세트 (v4 pro 모듈,110 1개 ,90 4개 ,50 2개, 30 2개) ","category":"모듈 (세트,단품)","image":"", "price": "477225"},
    {"id":"oem_se_pro_set","name":"순정연동 SE PRO 모듈 1개 세트 (se pro 모듈,110 1개 ,90 4개 ,50 2개, 30 2개)","category":"모듈 (세트,단품)","image":"", "price": "392175"},
    ...
    {"id":"foot_rgb_acrylic_4pcs","name":"RGB 풋등 아크릴 1대분 4PCS","category":"아크릴 & 몰딩","image":"foot", "price": "1815"},
    {"id":"foot_moving_acrylic_4pcs","name":"무빙 풋등 아크릴 1대분 4PCS","category":"아크릴 & 몰딩","image":"foot", "price": "2420"},
    ...
    {"id":"tape_sookwang_5mm","name":"아크릴 전용 3M 수광 테이프(투명) 5mm","category":"배선/커넥터/부자재","image":"SOOKWANG", "price": "1650"},
    ...
    {"id":"fuse_10a","name":"퓨즈 10A","category":"배선/커넥터/부자재","image":"FUSE10A", "price": "1650"},
