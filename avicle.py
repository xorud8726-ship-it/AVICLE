...
# ---------------------------------------------------------------------------
SHIPPING_FEE = 4000
SHIPPING_NAME = "택배비 (부가세 별도)"

# ---------------------------------------------------------------------------
# 품목 카탈로그
# ---------------------------------------------------------------------------
ITEMS: List[Dict[str, str]] = [
    {"id":"rgb_led_110","name":"RGB 110cm","category":"LED (RGB/무빙)","image":"led", "price": "29400"},
    {"id":"rgb_led_90","name":"RGB 90cm","category":"LED (RGB/무빙)","image":"led", "price": "26300"},
    {"id":"moving_led_110","name":"무빙 110cm","category":"LED (RGB/무빙)","image":"led", "price": "39900"},
    {"id":"moving_led_90","name":"무빙 90cm","category":"LED (RGB/무빙)","image":"led", "price": "30500"},
    {"id":"moving_led_50","name":"무빙 50cm","category":"LED (RGB/무빙)","image":"led", "price": "18900"},
    {"id":"moving_led_30","name":"무빙 30cm","category":"LED (RGB/무빙)","image":"led", "price": "15800"},
    {"id":"moving_led_15_soldout","name":"무빙 15cm(품절)","category":"LED (RGB/무빙)","image":"led", "price": "11600"},
    {"id":"haodeng_bt","name":"RGB 블루투스 모듈(하우동)","category":"모듈 (세트,단품)","image":"haodeng", "price": "22000"},
    {"id":"oem_rgb_set","name":"순정연동 RGB 모듈 1개 세트(RGB 모듈,110 1개 ,90 4개)","category":"모듈 (세트,단품)","image":"rgb110", "price": "183800"},
    {"id":"oem_se_set","name":"순정연동 SE 모듈 1개 세트(se 모듈,110 1개 ,90 4개)","category":"모듈 (세트,단품)","image":"rgb110", "price": "281400"},
    {"id":"oem_v4_set","name":"순정연동 V4 모듈 1개 세트 (v4 모듈,110 1개 ,90 4개) ","category":"모듈 (세트,단품)","image":"rgb110", "price": "375900"},
    {"id":"universal_se_set","name":"유니버셜 se 모듈 1개 세트 (se 모듈 ,블루투스 모듈, 110 1개, 90 4개)","category":"모듈 (세트,단품)","image":"seset", "price": "333900"},
    {"id":"oem_rgb_single","name":"순정연동 RGB 모듈 1개 단품","category":"모듈 (세트,단품)","image":"rgb", "price": "63000"},
    {"id":"oem_se_single","name":"순정연동 SE 모듈 1개 단품","category":"모듈 (세트,단품)","image":"se", "price": "136500"},
    {"id":"oem_v4_single","name":"순정연동 V4 모듈 1개 단품 ","category":"모듈 (세트,단품)","image":"v4", "price": "231000"},
    {"id":"universal_se_single","name":"순정연동 어플 1개 단품","category":"모듈 (세트,단품)","image":"uni", "price": "52500"},
    {"id":"oem_v4_pro_set","name":"순정연동 V4 PRO 모듈 1개 세트 (v4 pro 모듈,110 1개 ,90 4개 ,50 2개, 30 2개) ","category":"모듈 (세트,단품)","image":"", "price": "477300"},
    {"id":"oem_se_pro_set","name":"순정연동 SE PRO 모듈 1개 세트 (se pro 모듈,110 1개 ,90 4개 ,50 2개, 30 2개)","category":"모듈 (세트,단품)","image":"", "price": "392200"},
    {"id":"oem_v4_pro_single","name":"순정연동 V4 PRO 모듈 1개 단품 ","category":"모듈 (세트,단품)","image":"v4", "price": "283500"},
    {"id":"oem_se_pro_single","name":"순정연동 SE PRO 모듈 1개 단품","category":"모듈 (세트,단품)","image":"se", "price": "189000"},
    {"id":"spk_acrylic_row1","name":"스피커 아크릴 (1열) 2PCS","category":"아크릴 & 몰딩","image":"tmvlzj", "price": "11000"},
    {"id":"spk_acrylic_row1_torres","name":"(토레스)스피커 아크릴 (1열) 2PCS","category":"아크릴 & 몰딩","image":"xhfptm", "price": "11000"},
    {"id":"foot_rgb_acrylic_4pcs","name":"RGB 풋등 아크릴 1대분 4PCS","category":"아크릴 & 몰딩","image":"foot", "price": "1900"},
    {"id":"foot_moving_acrylic_4pcs","name":"무빙 풋등 아크릴 1대분 4PCS","category":"아크릴 & 몰딩","image":"foot", "price": "2500"},
    {"id":"dial_acrylic_mq4_k8_ka4p","name":"다이얼 아크릴 MQ4(페리),K8(페리),KA4페리","category":"아크릴 & 몰딩","image":"ekdldjf", "price": "12100"},
    {"id":"dial_acrylic_nq5","name":"다이얼 아크릴 NQ5","category":"아크릴 & 몰딩","image":"ekdldjf", "price": "12100"},
    {"id":"dial_acrylic_old_ka4","name":"다이얼 아크릴 구형 KA4","category":"아크릴 & 몰딩","image":"ekdldjf", "price": "12100"},
    {"id":"dial_acrylic_dl3_ferry","name":"다이얼 아크릴 DL3(페리)","category":"아크릴 & 몰딩","image":"ekdldjf", "price": "12100"},
    {"id":"stinger_airvent_row1","name":"스팅어 벤풍구 아크릴 1열","category":"아크릴 & 몰딩","image":"Stinger1", "price": "11000"},
    {"id":"stinger_airvent_row2","name":"스팅어 벤풍구 아크릴 2열","category":"아크릴 & 몰딩","image":"stinger2", "price": "11000"},
    {"id":"cupholder_wing","name":"컵홀더 (날개)(LED없음)","category":"컵홀더 윙","image":"cupwing", "price": "33000"},
    {"id":"conn_4p_100","name":"4P 커넥터 100PCS (암,숫)","category":"배선/커넥터/부자재","image":"4pconnet", "price": "33000"},
    {"id":"harness_pin_ket_100","name":"하네스 핀 KET 암,숫 100PCS","category":"배선/커넥터/부자재","image":"ket", "price": "55000"},
    {"id":"harness_pin_amp_100","name":"하네스 핀 AMP 암,숫 100PCS","category":"배선/커넥터/부자재","image":"ket", "price": "110000"},
    {"id":"conn_y_50","name":"Y자 커넥터 50PCS","category":"배선/커넥터/부자재","image":"4pY", "price": "55000"},
    {"id":"power_cable","name":"전원케이블","category":"배선/커넥터/부자재","image":"MAINPOWER", "price": "44000"},
    {"id":"music_switch","name":"음악반응 스위치","category":"배선/커넥터/부자재","image":"MUSICBUTTON", "price": "11000"},
    {"id":"tape_3m_gray","name":"3m 양면 테이프(회색)","category":"배선/커넥터/부자재","image":"3M", "price": "38500"},
    {"id":"tape_reflect","name":"반사 테이프","category":"배선/커넥터/부자재","image":"bansa", "price": "22000"},
    {"id":"tape_sookwang_5mm","name":"아크릴 전용 3M 수광 테이프(투명) 5mm","category":"배선/커넥터/부자재","image":"SOOKWANG", "price": "1700"},
    {"id":"tape_sookwang_3mm","name":"아크릴 전용 3M 수광 테이프(투명) 3mm","category":"배선/커넥터/부자재","image":"SOOKWANG", "price": "1100"},
    {"id":"foot_rgb_rollbar","name":"풋등 RGB 롤바","category":"배선/커넥터/부자재","image":"RGBRALL", "price": "27500"},
    {"id":"foot_moving_rollbar","name":"풋등 무빙 롤바","category":"배선/커넥터/부자재","image":"MOVINGRALL", "price": "44000"},
    {"id":"rgb_one_shot","name":"RGB 단발 LED","category":"배선/커넥터/부자재","image":"RGBONESHOT", "price": "8800"},
    {"id":"steer_remote_5_1k","name":"핸들 리모컨 5.1K 저항","category":"배선/커넥터/부자재","image":"5.1K", "price": "1100"},
    {"id":"fuse_10a","name":"퓨즈 10A","category":"배선/커넥터/부자재","image":"FUSE10A", "price": "1700"},
    {"id":"stinger_airvent1","name":"벤풍구 1열 (스팅어) 품절","category":"배선/커넥터/부자재","image":"STINGERAIRVENT1", "price": "132000"},
    {"id":"stinger_airvent2","name":"벤풍구 2열 (스팅어) 품절","category":"배선/커넥터/부자재","image":"STINGERAIRVENT2", "price": "110000"},
    {"id":"foot_rgb_row1","name":"RGB 풋등 1열 (2개)","category":"완제품 세트","image":"rgbfoot", "price": "16500"},
    {"id":"foot_rgb_row2","name":"RGB 풋등 2열 (2개)","category":"완제품 세트","image":"rgbfoot", "price": "22000"},
    {"id":"foot_moving_row1","name":"무빙 풋등 1열 (2개)","category":"완제품 세트","image":"movingfoot", "price": "16500"},
    {"id":"foot_moving_row2","name":"무빙 풋등 2열 (2개)","category":"완제품 세트","image":"movingfoot", "price": "22000"},
    {"id":"speaker_rgb_set","name":"RGB 스피커 2개 1SET","category":"완제품 세트","image":"speaker", "price": "55000"},
    {"id":"speaker_moving_set","name":"무빙 스피커 2개 1SET","category":"완제품 세트","image":"speaker", "price": "66000"},
    {"id":"mq4_rgb_front","name":"쏘렌토MQ4 RGB 전면","category":"완제품 세트","image":"mq4center", "price": "66000"},
    {"id":"mq4_moving_front","name":"쏘렌토MQ4 무빙 전면","category":"완제품 세트","image":"mq4center", "price": "77000"},
    {"id":"palisade_rgb_front","name":"신형팰리세이드 RGB 전면","category":"완제품 세트","image":"palisadedoor", "price": "66000"},
    {"id":"palisade_moving_front","name":"신형팰리세이드 무빙 전면","category":"완제품 세트","image":"thenewpalisade", "price": "77000"},
    {"id":"palisade_rgb_door","name":"신형,구형 팰리세이드 RGB 도어","category":"완제품 세트","image":"palisadedoor", "price": "154000"},
    {"id":"palisade_moving_door","name":"신형,구형 팰리세이드 무빙 도어","category":"완제품 세트","image":"palisadedoor", "price": "198000"},
    {"id":"gn7_rgb_front","name":"그랜져GN7 RGB 전면","category":"완제품 세트","image":"gn7center", "price": "55000"},
    {"id":"gn7_moving_front","name":"그랜져GN7 무빙 전면","category":"완제품 세트","image":"gn7center", "price": "66000"},
    {"id":"gn7_rgb_door","name":"그랜져GN7 RGB 도어","category":"완제품 세트","image":"gn7door", "price": "154000"},
    {"id":"gn7_moving_door","name":"그랜져GN7 무빙 도어","category":"완제품 세트","image":"gn7door", "price": "198000"},
]
...
class OrderApp:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("협력사 발주 프로그램 (v2.1 Shipping System)")
    ...
    def update_price_display(self, name: str):
        ...
        self.price_info_label.config(text=f"공급가: {price_val:,}원 | 부가세포함: {vat_val:,}원")
    ...
    # 장바구니 및 택배 로직
    # -----------------------------------------------------------------------
    def _insert_shipping_fee_if_needed(self):
        """장바구니에 상품이 들어올 때 택배비를 자동 삽입"""
        for iid in self.cart_tree.get_children():
            if self.cart_tree.item(iid, "values")[0] == SHIPPING_NAME:
                return
        self.cart_tree.insert("", "end", values=(SHIPPING_NAME, 1, f"{SHIPPING_FEE:,}", f"{SHIPPING_FEE:,}"))
    ...
    def add_to_cart(self):
        ...
        # 택배비 자동 추가 로직 실행
        self._insert_shipping_fee_if_needed()
    ...
    def remove_selected(self, silent_if_empty: bool = False):
        ...
        for iid in sel:
            # 택배비 행은 개별 삭제 불가 (상품 삭제 시 자동 관리됨)
            if self.cart_tree.item(iid, "values")[0] == SHIPPING_NAME:
                continue
            self.cart_tree.delete(iid)
        
        # 실제 상품이 하나도 남지 않았다면 택배비도 삭제
        all_items = self.cart_tree.get_children()
        ...
        if not has_real_product and shipping_iid:
            self.cart_tree.delete(shipping_iid)
    ...
    def submit_order(self):
        ...
        if not has_real_product:
            messagebox.showwarning("오류", "장바구니에 주문할 상품이 없습니다.")
            return
